    ...
    double *restrict c)
{
    ...
    ymm15 = _mm256_broadcast_sd(&ALPHA);

    for (int p = 0; p != k_iter; ++p)
    {
        ymm14 = _mm256_load_pd(bptr);
        ymm13 = _mm256_mul_pd(ymm15, _mm256_broadcast_sd(aptr + 0));
        ymm0 = _mm256_fmadd_pd(ymm13, ymm14, ymm0);
        ymm1 = _mm256_fmadd_pd(ymm13, ymm14, ymm1);

        ymm14 = _mm256_load_pd(bptr + 4);
        ymm12 = _mm256_mul_pd(ymm15, _mm256_broadcast_sd(aptr + 1));
        ymm2 = _mm256_fmadd_pd(ymm12, ymm14, ymm2);
        ymm3 = _mm256_fmadd_pd(ymm12, ymm14, ymm3);

        ymm14 = _mm256_load_pd(bptr + 8);
        ymm13 = _mm256_mul_pd(ymm15, _mm256_broadcast_sd(aptr + 2));
        ymm4 = _mm256_fmadd_pd(ymm13, ymm14, ymm4);
        ymm5 = _mm256_fmadd_pd(ymm13, ymm14, ymm5);

        ymm14 = _mm256_load_pd(bptr + 12);
        ymm12 = _mm256_mul_pd(ymm15, _mm256_broadcast_sd(aptr + 3));
        ymm6 = _mm256_fmadd_pd(ymm12, ymm14, ymm6);
        ymm7 = _mm256_fmadd_pd(ymm12, ymm14, ymm7);

        ymm14 = _mm256_load_pd(bptr + 16);
        ymm13 = _mm256_mul_pd(ymm15, _mm256_broadcast_sd(aptr + 4));
        ymm8 = _mm256_fmadd_pd(ymm13, ymm14, ymm8);
        ymm9 = _mm256_fmadd_pd(ymm13, ymm14, ymm9);

        ymm14 = _mm256_load_pd(bptr + 20);
        ymm12 = _mm256_mul_pd(ymm15, _mm256_broadcast_sd(aptr + 5));
        ymm10 = _mm256_fmadd_pd(ymm12, ymm14, ymm10);
